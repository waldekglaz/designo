...
const HeroSecondary = ({ title, text }: HeroSecondaryProps) => {
  return (
    <div className="bg-hero-pattern bg-right-top  bg-contain  bg-no-repeat bg-orange text-center py-28 text-white px-6 md:rounded-xl md:py-16 md:rounded-t-none md:mb-32">
